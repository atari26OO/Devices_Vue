<template>
  <div id="devices">
    ...
    <table> <!-- awwwkkk -->
      ...
      <tr>
        <td><span id='load_name'>{{devices.load.name}}</span></td>
        <td><span id='load_id'>{{devices.load.id}}</span></td>
        <td><span id='load_value'>{{devices.load.value}}</span></td>
        <td><span id='load_datetime'>{{devices.load.datetime}}</span></td>
      </tr>
      <tr>
        <td><span id='bh_name'>{{devices.blockheight.name}}</span></td>
        <td><span id='bh_id'>{{devices.blockheight.id}}</span></td>
        <td><span id='bh_value'>{{devices.blockheight.value}}</span></td>
        <td><span id='bh_datetime'>{{devices.blockheight.datetime}}</span></td>
        <td></td>
      </tr>
      <tr>
        <td><span id='pressure_name'>{{devices.pressure.name}}</span></td>
        <td><span id='pressure_id'>{{devices.pressure.id}}</span></td>
        <td><span id='pressure_value'>{{devices.pressure.value}}</span></td>
        <td><span id='pressure_datetime'>{{devices.pressure.datetime}}</span></td>
        <td></td>
      </tr>
    </table>
...
export default {
  ...
  created: function() {
    ...
    this.receiveMessage('{"id":"f7cb80bb41552f1ef77c527c83f6f64f","name":"Block Height","value":"976","timestamp":"1640654430613"}')
